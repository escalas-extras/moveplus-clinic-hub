...
import { FINANCE_OPS_GRID } from "./finance-layout";
  ...
  return (
    ...
    >
      <PageSection
        ...
        description="Acesso rápido a recebimentos, pagamentos, fluxo, recibos, pacotes, convênios e inadimplência."
        contentClassName="p-0"
      >
        <section aria-label="Operação financeira" className={FINANCE_OPS_GRID}>
          ...
          <FinanceOperationCard
            ...
            icon={Receipt}
            accent="#a855f7"
            headline="Emissão em lote"
            to={FINANCE_ROUTES.recibos}
            metrics={[
              { label: "Função", value: "Imprimir e baixar PDF" },
            ]}
          />
          <FinanceOperationCard
            title="Pacotes"
