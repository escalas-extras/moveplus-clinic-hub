...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Move 60+ — Gestão Clínica" },
      { name: "description", content: "Sistema de gestão clínica e prontuário eletrônico Move 60+." },
      { property: "og:title", content: "Move 60+ — Gestão Clínica" },
      { property: "og:description", content: "Sistema de gestão clínica e prontuário eletrônico Move 60+." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Move 60+ — Gestão Clínica" },
      { name: "twitter:description", content: "Sistema de gestão clínica e prontuário eletrônico Move 60+." },
